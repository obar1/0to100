...
from zero_to_one_hundred.src.zero_to_one_hundred.processors.yt_download_processor import YTDownloadProcessor
...
def test_yt_download_processor():
    ...
    with patch("pytube.YouTube") as MockYouTube:
        mock_stream = MockYouTube.return_value.streams.get_highest_resolution.return_value
