...
1. # <https§§§www.cloudskillsboost.google§123> [`here`](./0to100/https§§§www.cloudskillsboost.google§123/readme.md) `done` :cloud:
1. # Python in 100 Seconds [`here`](./0to100/https§§§www.youtube.com§watch§v§x7X9w_GIm1s/readme.md) `wip` <img src='https://upload.wikimedia.org/wikipedia/commons/b/b8/YouTube_Logo_2017.svg' alt='YouTube Logo' width='64'>
