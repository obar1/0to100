...
def test_get_processor(get_config_map,get_args_get_processor):
    actual = ZTOHFactory(get_config_map, PersistFS)
...
def test_section_processor(get_config_map,get_args_create_section_processor):
    actual = ZTOHFactory(get_config_map, PersistFS).get_processor(get_args_create_section_processor)
...
def test_refresh_sections_processor(get_config_map,get_args_refresh_sections_processor):
    actual :RefreshSectionsProcessor= ZTOHFactory(get_config_map, PersistFS).get_processor(get_args_refresh_sections_processor)
