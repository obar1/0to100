...
def test_asMarkDown(get_config_map: ZTOHConfigMap, persist_fs, process_fs,
...
def test_asMarkDown_0(get_config_map_sorted_0: ZTOHConfigMap, persist_fs, process_fs,
...
def test_asMarkDown_1(get_config_map_sorted_1: ZTOHConfigMap, persist_fs, process_fs,
                      http_urls=['https://cloud.google.com/abc', 'https://cloud.google.com/zzz',
                                 'https://cloud.google.com/efg']):
...
def test_write(get_config_map: ZTOHConfigMap, persist_fs, process_fs,
               http_urls=['https://cloud.google.com/abc', 'https://cloud.google.com/zzz']):
    sections = [Section(get_config_map, persist_fs, process_fs, http_url, False) for http_url in http_urls]
    actual = Map(get_config_map, persist_fs, sections=sections)
